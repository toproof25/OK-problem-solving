...
3. `몫을 저장할 변수를 설정한다`
4. `거스름돈을 25로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
5. `거스름돈을 10로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
6. `거스름돈을 5로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
7. `거스름돈을 1로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
