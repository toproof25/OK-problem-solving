...
### ***의사 코드***
1. `반복 횟수를 입력받는다 number`
2. `거스름돈을 입력받는다 change`
3. `몫을 저장할 변수를 설정한다`
4. `거스름돈을 0.25로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
5. `거스름돈을 0.1로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
6. `거스름돈을 0.05로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
7. `거스름돈을 0.01로 나눈 몫을 변수에 설정후 출력, 나머지를 거스름돈으로 변경한다`
