...
### ***의사 코드***
1. 기약분수 = 분자와 분모의 공약수가 1인 변수
2. 기약분수를 만드는 방법... 최대공약수로 나눈다. --> gcd 재귀 함수 [[유클리드 호제법(GCD)]]
3. 소인수가 2와 5만 존재하는지 확인하는 방법... --> 소인수 구하는 알고리즘 [[n의 소인수 구하기]]
	1. 소인수 구하는 방법. i=2부터 반복
	2. n%i가 0이면 i를 소인수로 등록하고, n = n/i를 설정, 이후 i는 다시 1부터 반복
	3. n이 1이 될때까지 반복한다.
